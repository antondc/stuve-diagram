  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      ...
      \begin{axis}[
        ...
        % LABEL
        \addplot [black,dashed,select coords between index={0}{0},yshift=1mm,font=\scriptsize] table [x expr={0}, y=pressure, col sep=comma] {#1} node [right] at (axis cs:-95,\pressure) {\pgfmathprintnumber{\altitude} \space m.};
        % LINE
        \addplot [black,dashed,select coords between index={0}{0},yshift=-0.3mm,opacity=0.5] table [x expr={0}, y=pressure, col sep=comma] {#1} node {———————————————————————————————————————————————————————————————————};
      \end{axis}
