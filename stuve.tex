...
Also, we shoult take into account that in Stuve diagrams we want to draw the dry adiabats as straight lines. Thus \( y \) axis is not logarithmic, but progressing in a ratio of \( y^{0.286} \).
