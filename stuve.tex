...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \addplot [red,thick] table [col sep=comma,header=false] {temperature.csv};
    \addplot [teal,thick] table [col sep=comma,header=false] {dew_point.csv};
    \addplot [black,dashed] table [col sep=comma,header=false] {altitude.csv};
  \end{axis}
  \begin{axis}[
      xmin=-95,
      xmax=45,
