...
\begin{verbatim}
  ((0.23620100952 * exp((12.27 * \T)/(237.3 + \T))) +
  (x * 0.61078 * exp((12.27 * \T)/(237.3 + \T))) / x) * 10
\end{verbatim}
...
We know that \( T \) refers to the \( x \) axis, and \( p \) to the \( y \) axis, so the strategy would be to solve for \( p \).
...
\[ T = x \qquad p = y \qquad \varepsilon = 0.622 \]

\[ y  = \frac{\biggl(0.622 \cdot 0.61078 \cdot \exp \biggl(\frac{12.27 \cdot x}{237.3 + x}\biggr)\biggr) + \biggl( r_s \cdot 0.61078 \cdot \exp \bigl(\frac{12.27 \cdot x}{237.3 + x} \bigr)\biggr) }{r_s} \]

Which, we should be able to use in LaTeX when passing fixed values of \( r_s \):

\[ r_s = 2 \]

\begin{verbatim}
  y = ( 0.622 * 0.61078 * exp( ( 12.27 * x ) / ( 237.3 + x )) + (2 * 0.61078 *
  exp( ( 12.27 * x ) / ( 237.3 + x )) )) / ( 2 )
\end{verbatim}
...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \addplot [red, domain=-95:45] {( 0.622 * 0.61078 * exp( ( 12.27 * (x + 273.15) ) / ( 237.3 + (x + 273.15) )) + (2 * 0.61078 *  exp( ( 12.27 * (x + 273.15) ) / ( 237.3 + (x + 273.15) )) )) / ( 2 )};
...
\[ y = \frac{exp\biggl(\frac{x - 273.15}{x \cdot 273.15 \cdot 0.0001844}\biggr) \cdot 0.6113 \cdot (r_s + 0.622)}{r_s} \]

Which, we should be able to use in LaTeX when passing fixed values of \( r_s \) and converting T to Kelvin:

\[ r_s = 2 \]

\[ y = \frac{exp\biggl(\frac{(x + 273.15) - 273.15}{(x + 273.15) \cdot 273.15 \cdot 0.0001844}\biggr) \cdot 0.6113 \cdot (2 + 0.622)}{2} \]

\begin{verbatim}
  (exp(((x + 273.15) - 273.15) / ((x + 273.15) * 273.15 * 0.0001844))
  * 0.6113 * (2 + 0.622 ) ) / (2)
\end{verbatim}
...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \addplot [blue, loosely dashed, domain=-95:45] { (exp(((x + 273.15) - 273.15) / ((x + 273.15) * 273.15 * 0.0001844)) * 0.6113 * (2 + 0.622 ) ) / (2) };
  \end{axis}
\end{tikzpicture}
